$.fn.digitsOnly = function(){ 
	$(this).keypress(function(event) {
		...
		if (!event.which || (48 <= event.which && event.which <= 57) || (48 == event.which && $(this).attr("value"))) {
			return;
		} else {
...
$.fn.autosize = function(){
	$(this).each(function(){
		$(this).on('input.autosize',function(){
...
$.fn.textInput = function(){
	$(this).each(function(){
		...
		if (input.attr('type') == 'password') {
			wrapper.append('<div class="form__input-password-icon _no"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path fill="#A7ADC8" fill-rule="evenodd" d="M4.14 8.77a.65.65 0 0 1 .84.372c2.475 6.42 11.558 6.42 14.033 0a.65.65 0 0 1 1.213.468c-2.903 7.53-13.557 7.53-16.46 0a.65.65 0 0 1 .373-.84Z" clip-rule="evenodd"/><path fill="#A7ADC8" fill-rule="evenodd" d="M11.348 18.486v-3.923h1.3v3.923a.65.65 0 0 1-1.3 0ZM5.614 17.07l1.962-3.398 1.126.65-1.962 3.397a.65.65 0 0 1-1.126-.65ZM2.081 13.877l2.774-2.774.92.92L3 14.797a.65.65 0 0 1-.919-.92ZM21.915 13.877l-2.774-2.774-.919.92 2.774 2.774a.65.65 0 0 0 .92-.92ZM18.382 17.07l-1.962-3.398-1.125.65 1.961 3.397a.65.65 0 0 0 1.126-.65Z" clip-rule="evenodd"/></svg></div><div class="form__input-password-icon _yes"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path fill="#A7ADC8" fill-rule="evenodd" d="M18.592 12.242c-2.573 5.593-10.611 5.593-13.184 0C7.95 6.6 16.05 6.6 18.592 12.242Zm1.408.005c-2.822 7.32-13.178 7.32-16 0 2.78-7.381 13.22-7.381 16 0Z" clip-rule="evenodd"/><path fill="#A7ADC8" fill-rule="evenodd" d="M12.001 13.007a1.007 1.007 0 1 0 0-2.014 1.007 1.007 0 0 0 0 2.014Zm0 1.3a2.307 2.307 0 1 0 0-4.614 2.307 2.307 0 0 0 0 4.614Z" clip-rule="evenodd"/></svg></div>');
...
$.fn.select = function(){
	...
	$(this).each(function(){
		var s = $(this),
			...
			val = input.val();
		label.wrapInner('<div class="select__label-text"></div>').append('<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="#20212B" stroke-width="1.6" d="m7.757 11 4.172 4.172a.1.1 0 0 0 .142 0L16.243 11"/></svg>');
