(function(){
    ...
    var duration = parseFloat(getComputedStyle(document.documentElement).getPropertyValue("--popup-trs")) * 1000;
    ...
    $('body').on('click','._js-popup',function(){
		...
		if (this.tagName == 'A') {
			if (this.getAttribute('href').charAt(0) == '#') {
				...
				data.el = $('<div class="video-box"><iframe src="https://www.youtube.com/embed/'+youtube_parser(this.getAttribute('href'))+'" frameborder="0" allow="autoplay; encrypted-media;" allowfullscreen></iframe></div>');
