...
var mql = {
  1440: window.matchMedia('(max-width: 1440px)'),
  1200: window.matchMedia('(max-width: 1200px)'),
  1024: window.matchMedia('(max-width: 1024px)'),
  1000: window.matchMedia('(max-width: 1000px)'),
  900: window.matchMedia('(max-width: 900px)'),
  768: window.matchMedia('(max-width: 768px)'),
  767: window.matchMedia('(max-width: 767px)'),
  760: window.matchMedia('(max-width: 760px)'),
  600: window.matchMedia('(max-width: 600px)'),
};

var Z = {
  ios: navigator.userAgent.match(/like Mac OS X/i) ? true : false,
  touch: 'ontouchstart' in document.documentElement ? true : false,
  oldie: navigator.userAgent.match(/Trident\/7\./) ? true : false,
  ...
  email2: /^([A-Za-z0-9_\-\.])+\@([A-Za-z0-9_\-\.])+\.([A-Za-z]{2,4})$/,
  email: /\S+@\S+\.\S{2,4}/,
  url: /^(https?|ftp):\/\/(((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:)*@)?(((\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5]))|((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?)(:\d*)?)(\/((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)+(\/(([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)*)*)?)?(\?((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|[\uE000-\uF8FF]|\/|\?)*)?(\#((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|\/|\?)*)?$/i,
  MQLT750: window.matchMedia ? window.matchMedia('(max-width: 750px)') : { matches: false },
  scrollBodyTo: function (top, options) {
    ...
    if (options && options.anim === false) {
      D.scrollTop(top);
    } else {
      $('html')
        .stop()
        .animate({ scrollTop: top }, term, 'easeOutExpo', function () {
          scrollWorking = false;
          $(window).off('mousewheel.scrollto');
          // if (f) f();
        });
      $(window).on('mousewheel.scrollto', function (event, delta) {
        if (scrollWorking) {
          $('html').stop();
          scrollWorking = false;
          $(window).off('mousewheel.scrollto');
  ...
  formatBytes: function (a, b) {
    ...
    var c = 1024,
      d = b || 2,
      e = ['б', 'Кб', 'Мб', 'Гб', 'Тб', 'Пб', 'Эб', 'Зб', 'Йб'],
      f = Math.floor(Math.log(a) / Math.log(c));
    return parseFloat((a / Math.pow(c, f)).toFixed(d)) + ' ' + e[f];
  },
};
if (Z.isWindows) $('html').addClass('_os-windows');
...
if (Z.firefox) $('html').addClass('firefox');
...
!(function (e) {
  ...
  if (a.event.fixHooks) for (var n = e.length; n; ) a.event.fixHooks[e[--n]] = a.event.mouseHooks;
  ...
  function i(e) {
    ...
    if (
      ...
      return (
        1 === n.deltaMode
          ? ((o *= t = a.data(this, 'mousewheel-line-height')), (s *= t), (l *= t))
          : 2 === n.deltaMode &&
            ((o *= t = a.data(this, 'mousewheel-page-height')), (s *= t), (l *= t)),
...
!(function (a) {
  'function' == typeof define && define.amd
    ? define(['resources/assets/js/lib/jquery.js'], a)
    : a('object' == typeof exports ? require('resources/assets/js/lib/jquery.js') : jQuery);
})(function (a) {
  var b,
...
$.fn.replaceSVG = function () {
  $(this).each(function () {
    var $img = $(this).removeClass('js-replace-svg');
...
$.fn.randomize = function (tree, childElem) {
  return this.each(function () {
    ...
    for (var i = 0; i < elems.length; i++) unsortedElems.eq(i).replaceWith(elems[i]);
  });
};
  ...
  $(this).each(function () {
    ...
    function handleGesture() {
      if (touchendX < touchstartX) {
        ...
        gestureZone.trigger('swipe:left');
      }

      if (touchendX > touchstartX) {
        console.log('Swiped right');
        gestureZone.trigger('swipe:right');
      }

      if (touchendY < touchstartY) {
        console.log('Swiped up');
        gestureZone.trigger('swipe:up');
      }

      if (touchendY > touchstartY) {
        console.log('Swiped down');
        gestureZone.trigger('swipe:down');
      }

      if (touchendY === touchstartY) {
        console.log('Tap');
        gestureZone.trigger('tap');
      }
    }
  });
};
