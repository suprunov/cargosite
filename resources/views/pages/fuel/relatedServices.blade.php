...
@section('content')
    ...
    <div class="pathBar">
        <div class="pathBar__inner">
            ...
            <span class="pathBar__item _active">сопутствующие услуги</span>
        </div>
    </div>
    ...
    <section class="content-hero fuel-related-services__hero">
        <div class="folder-white">
            <div class="folder-white__body">
                <div class="content-hero__inner">
                    <div class="content-hero__body">
                        <h1 class="content-hero__heading">Оплачивайте шиномонтаж с&nbsp;единого счёта ППР</h1>
                        <p class="content-hero__copy">Для грузовых и&nbsp;легковых авто юридических лиц</p>
                        <p class="content-hero__cta">
                            <a href="#apply" class="btn-cta">Сократить расходы</a>
                        </p>
                    </div>
                    <div class="content-hero__image"><img
                            src="/local/templates/main/assets/img/fuel/related-services/hero.jpg"
                            alt=""
                            loading="lazy"
                        ></div>
                </div>
